...
class LandingpagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create landingpage" do
    assert_difference('Landingpage.count') do
      post landingpages_url, params: { landingpage: { password: @landingpage.password, username: @landingpage.username } }
    end
  ...
  test "should update landingpage" do
    patch landingpage_url(@landingpage), params: { landingpage: { password: @landingpage.password, username: @landingpage.username } }
